...
class CharacterStatsExtractor:
    ...
    def extract_from_screenshot(self, screenshot_path: str, template_path: str, debug: bool = False) -> CharacterStats:
    ...
    def extract_to_json(self, screenshot_path: str, template_path: str, output_path: Optional[str] = None, debug: bool = False) -> str:
